...
class ConstError : public ceres::SizedCostFunction<Dim /* number of residuals */, Dim /* size of first parameter */>,
                   public ErrorInterface
{
  public:
    ...
    ConstError(const Eigen::VectorXd &value, const Eigen::Matrix<double, Dim, Dim> &information)
    {
                                      ...
                                      double **jacobians_minimal) const
    {
        ...
        if (jacobians != nullptr)
        {
            if (jacobians[0] != nullptr)
            {
                ...
                {
                    Eigen::Map<Eigen::Matrix<double, Dim, Dim, Eigen::RowMajor>> J0_minimal_mapped(
                        jacobians_minimal[0]);
