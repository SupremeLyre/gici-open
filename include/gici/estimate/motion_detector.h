...
class MotionDetector
{
  public:
     ...
     */
    void setFrames(const FrameBundlePtr &last_frames, const FrameBundlePtr &new_frames)
    {
  ...
  private:
     ...
     */
    int findFeatureCorrespondences(Keypoints &features_last, Keypoints &features_new) const;
     ...
     */
    bool findFeatureCorrespondence(const size_t cam_index, const int track_id, Keypoint *last_px) const;
