...
class RelativeConstError
    : public ceres::SizedCostFunction<Dim /* number of residuals */, Dim, /* size of first parameter: previous */
                                      ...
                                      double **jacobians_minimal) const
    {
        ...
        if (jacobians != nullptr)
        {
            ...
            if (jacobians[1] != nullptr)
            {
                ...
                {
                    Eigen::Map<Eigen::Matrix<double, Dim, Dim, Eigen::RowMajor>> J1_minimal_mapped(
                        jacobians_minimal[1]);
