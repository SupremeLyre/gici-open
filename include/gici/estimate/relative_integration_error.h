...
class RelativeIntegrationError
    : public ceres::SizedCostFunction<2 * Dim /* number of residuals */, Dim, /* size of first parameter: previous */
                                      ...
                                      double **jacobians_minimal) const
    {
        ...
        if (jacobians != nullptr)
        {
            if (jacobians[0] != nullptr)
            {
                ...
                {
                    Eigen::Map<Eigen::Matrix<double, 2 * Dim, Dim, Eigen::RowMajor>> J0_minimal_mapped(
                        jacobians_minimal[0]);
            ...
            if (jacobians[1] != nullptr)
            {
                ...
                {
                    Eigen::Map<Eigen::Matrix<double, 2 * Dim, Dim, Eigen::RowMajor>> J1_minimal_mapped(
                        jacobians_minimal[1]);
            ...
            if (jacobians[2] != nullptr)
            {
                ...
                {
                    Eigen::Map<Eigen::Matrix<double, 2 * Dim, Dim, Eigen::RowMajor>> J2_minimal_mapped(
                        jacobians_minimal[2]);
            ...
            if (jacobians[3] != nullptr)
            {
                ...
                {
                    Eigen::Map<Eigen::Matrix<double, 2 * Dim, Dim, Eigen::RowMajor>> J3_minimal_mapped(
                        jacobians_minimal[3]);
