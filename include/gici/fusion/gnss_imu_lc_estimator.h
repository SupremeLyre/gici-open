...
// Estimator
class GnssImuLcEstimator : public GnssLooseEstimatorBase, public ImuEstimatorBase
{
  public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW

    GnssImuLcEstimator(const GnssImuLcEstimatorOptions &options, const GnssImuInitializerOptions &init_options,
