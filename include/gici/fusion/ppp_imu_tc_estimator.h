...
// Estimator
class PppImuTcEstimator : public GnssEstimatorBase, public ImuEstimatorBase
{
  public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW

    PppImuTcEstimator(const PppImuTcEstimatorOptions &options, const GnssImuInitializerOptions &init_options,
