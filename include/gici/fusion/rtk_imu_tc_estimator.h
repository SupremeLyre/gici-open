...
// Estimator
class RtkImuTcEstimator : public GnssEstimatorBase, public ImuEstimatorBase
{
  public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW

    RtkImuTcEstimator(const RtkImuTcEstimatorOptions &options, const GnssImuInitializerOptions &init_options,
    ...
    void setInitializationResult(const std::shared_ptr<MultisensorInitializerBase> &initializer) override;

  protected:
    // Add GNSS measurements and state
    bool addGnssMeasurementAndState(const GnssMeasurement &measurement_rov, const GnssMeasurement &measurement_ref);
