...
// Estimator
class SppImuTcEstimator : public GnssEstimatorBase, public ImuEstimatorBase
{
  public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW

    SppImuTcEstimator(const SppImuTcEstimatorOptions &options, const GnssImuInitializerOptions &init_options,
