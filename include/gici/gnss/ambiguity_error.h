...
template <int... Ns>
class AmbiguityError : public ceres::SizedCostFunction<1 /* number of residuals */, Ns... /* parameter blocks */>,
                       public ErrorInterface
{
  public:
    ...
    AmbiguityError(const double measurement, const double information, const std::vector<double> &coefficients);
