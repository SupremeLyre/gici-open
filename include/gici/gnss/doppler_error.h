...
template <int... Ns>
class DopplerError : public ceres::SizedCostFunction<1 /* number of residuals */, Ns... /* parameter blocks */>,
                     public ErrorInterface
{
  public:
    ...
    DopplerError(const GnssMeasurement &measurement, const GnssMeasurementIndex index,
