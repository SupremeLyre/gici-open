...
bool checkObservationValid(const GnssMeasurement &measurement, const GnssMeasurementIndex &index,
                           const ObservationType type, const GnssCommonOptions &options = GnssCommonOptions(),
...
double troposphereSaastamoinen(double time, const Eigen::Vector3d &ecef, double elevation, double humi = 0.0);
...
double ionosphereBroadcast(double time, const Eigen::Vector3d &ecef, double azimuth, double elevation,
                           double wavelength, const Eigen::VectorXd &parameters = Eigen::VectorXd::Zero(8));
...
inline double ionosphereConvertToBase(double ionosphere, double wavelength)
{
    return ionosphere * square(CLIGHT / FREQ1 / wavelength);
}

// Convert ionosphere delay from 1575.42 MHz to given wavelength
inline double ionosphereConvertFromBase(double ionosphere, double wavelength)
{
...
Eigen::Vector4d computeDops(const GnssMeasurement &measurement, const GnssCommonOptions &options = GnssCommonOptions());
