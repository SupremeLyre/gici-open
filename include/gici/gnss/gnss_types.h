...
struct GnssMeasurementIndex
{
    ...
    GnssMeasurementIndex(std::string prn, int code_type) : prn(prn), code_type(code_type)
    {
    }
    std::string prn;
    int code_type;
...
{
    GnssMeasurementSDIndexPair() : rov(GnssMeasurementIndex()), ref(GnssMeasurementIndex())
    {
    }
    GnssMeasurementSDIndexPair(GnssMeasurementIndex rov, GnssMeasurementIndex ref) : rov(rov), ref(ref)
    {
    }
...
struct GnssMeasurementDDIndexPair
{
    GnssMeasurementDDIndexPair()
        : rov(GnssMeasurementIndex()), ref(GnssMeasurementIndex()), rov_base(GnssMeasurementIndex()),
          ref_base(GnssMeasurementIndex())
    {
    }
    GnssMeasurementDDIndexPair(GnssMeasurementIndex rov, GnssMeasurementIndex ref, GnssMeasurementIndex rov_base,
...
struct GnssErrorParameter
{
    ...
    // System error ratio
    std::map<char, double> system_error_ratio = {{'G', 1.0}, {'R', 5.0}, {'C', 2.0}, {'E', 1.5}};
