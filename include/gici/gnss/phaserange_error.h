...
template <int... Ns>
class PhaserangeError : public ceres::SizedCostFunction<1 /* number of residuals */, Ns... /* parameter blocks */>,
                        public ErrorInterface
{
  public:
    ...
    PhaserangeError(const GnssMeasurement &measurement, const GnssMeasurementIndex index,
