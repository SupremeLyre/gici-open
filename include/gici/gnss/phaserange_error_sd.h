...
template <int... Ns>
class PhaserangeErrorSD : public ceres::SizedCostFunction<1 /* number of residuals */, Ns... /* parameter blocks */>,
                          public ErrorInterface
{
  public:
    ...
    PhaserangeErrorSD(const GnssMeasurement &measurement_rov, const GnssMeasurement &measurement_ref,
