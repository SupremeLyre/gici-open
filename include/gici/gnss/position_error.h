...
//          in body frame (3)
template <int... Ns>
class PositionError : public ceres::SizedCostFunction<3 /* number of residuals */, Ns... /* parameter blocks */>,
                      public ErrorInterface
{
  public:
    ...
    PositionError(const Eigen::Vector3d &position_measurement, const Eigen::Matrix3d &information);
