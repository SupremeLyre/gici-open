...
template <int... Ns>
class PseudorangeError : public ceres::SizedCostFunction<1 /* number of residuals */, Ns... /* parameter blocks */>,
                         public ErrorInterface
{
  public:
    ...
    PseudorangeError(const GnssMeasurement &measurement, const GnssMeasurementIndex index,
