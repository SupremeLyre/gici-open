...
template <int... Ns>
class PseudorangeErrorDD : public ceres::SizedCostFunction<1 /* number of residuals */, Ns... /* parameter blocks */>,
                           public ErrorInterface
{
  public:
    ...
    PseudorangeErrorDD(const GnssMeasurement &measurement_rov, const GnssMeasurement &measurement_ref,
                       const GnssMeasurementIndex index_rov, const GnssMeasurementIndex index_ref,
                       const GnssMeasurementIndex index_rov_base, const GnssMeasurementIndex index_ref_base,
    ...
    void setMeasurement(const GnssMeasurement &measurement_rov, const GnssMeasurement &measurement_ref)
    {
    ...
    {
        return dims_.kNumParameterBlocks;
    }
  ...
  protected:
    ...
    Satellite satellite_rov_, satellite_ref_, satellite_rov_base_, satellite_ref_base_;
    Observation observation_rov_, observation_ref_, observation_rov_base_, observation_ref_base_;
