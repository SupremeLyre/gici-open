...
template <int... Ns>
class PseudorangeErrorSD : public ceres::SizedCostFunction<1 /* number of residuals */, Ns... /* parameter blocks */>,
                           public ErrorInterface
{
  public:
    ...
    PseudorangeErrorSD(const GnssMeasurement &measurement_rov, const GnssMeasurement &measurement_ref,
    ...
    {
        return GnssMeasurementSDIndexPair(GnssMeasurementIndex(satellite_rov_.prn, observation_rov_.raw_code),
