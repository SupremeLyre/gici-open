...
template <int... Ns>
class VelocityError : public ceres::SizedCostFunction<3 /* number of residuals */, Ns... /* parameter blocks */>,
                      public ErrorInterface
{
  public:
    ...
    VelocityError(const Eigen::Vector3d &velocity_measurement, const Eigen::Matrix3d &information);
