...
bool initPoseAndBiases(const ImuMeasurements &imu_measurements, const double gravity, Transformation &T_WS,
                       SpeedAndBias &speed_and_bias, const double timestamp_start = 0.0,
...
{
    return 9.7803267715 * (1 + 0.0052790414 * square(sin(lla[0])) + 0.0000232718 * pow(sin(lla[0]), 4)) +
           lla[2] * (0.0000000043977311 * square(sin(lla[0])) - 0.0000030876910891) +
           0.0000000000007211 * square(lla[2]);
}
