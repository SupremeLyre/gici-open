...
class RollAndPitchError : public ceres::SizedCostFunction<2 /* number of residuals */, 7 /* size of first parameter */>,
                          public ErrorInterface
{
  public:
    ...
    RollAndPitchError(const Eigen::Vector2d &measurement, const Eigen::Matrix2d &information);
    ...
    const Eigen::Vector2d &measurement() const
    {
        return measurement_;
    }
