...
class YawError : public ceres::SizedCostFunction<1 /* number of residuals */, 7 /* size of first parameter */>,
                 public ErrorInterface
{
  public:
    ...
    YawError(const double measurement, const double information);
