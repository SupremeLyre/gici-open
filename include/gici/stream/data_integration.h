...
class DataIntegrationBase
{
  public:
    ...
    DataIntegrationBase(const std::shared_ptr<EstimatingBase> &estimating,
    ...
    // Data callback
    virtual void dataCallback(const std::string &input_tag, const std::shared_ptr<DataCluster> &data) = 0;
...
{
  public:
    GnssDataIntegration(const std::shared_ptr<EstimatingBase> &estimating,
                        const std::vector<std::shared_ptr<Streaming>> &streamings,
                        const std::vector<std::string> &formator_tags,
                        const std::vector<std::vector<std::string>> &roles);
    ~GnssDataIntegration();
    ...
    // Data callback
    void dataCallback(const std::string &input_tag, const std::shared_ptr<DataCluster> &data) override;

  protected:
    // Handle GNSS data
    void handleGNSS(const std::string &formator_tag, const std::shared_ptr<DataCluster::GNSS> &gnss);
...
{
  public:
    ImuDataIntegration(const std::shared_ptr<EstimatingBase> &estimating,
                       const std::vector<std::shared_ptr<Streaming>> &streamings,
                       const std::vector<std::string> &formator_tags,
                       const std::vector<std::vector<std::string>> &roles)
  ...
  protected:
    // Handle IMU data
    void handleIMU(const std::string &formator_tag, const std::shared_ptr<DataCluster::IMU> &imu);
};
...
{
  public:
    ImageDataIntegration(const std::shared_ptr<EstimatingBase> &estimating,
                         const std::vector<std::shared_ptr<Streaming>> &streamings,
                         const std::vector<std::string> &formator_tags,
                         const std::vector<std::vector<std::string>> &roles)
        : DataIntegrationBase(estimating, streamings, formator_tags, roles)
  ...
  protected:
    // Handle Image data
    void handleImage(const std::string &formator_tag, const std::shared_ptr<DataCluster::Image> &image);
};
...
class SolutionDataIntegration : public DataIntegrationBase
{
  public:
    ...
    SolutionDataIntegration(const std::shared_ptr<EstimatingBase> &estimating,
                            const std::shared_ptr<EstimatingBase> &input_estimating, const std::string &input_tag,
    ...
    const bool isFromEstimator() const
    {
        return is_from_estimator_;
    }

  protected:
    // Handle Solution data
    void handleSolution(const std::string &input_tag, const std::shared_ptr<Solution> &solution);
    ...
    SolutionRole adjustSolutionRole(const Solution &solution, const SolutionRole &role);
