...
class SerialStreamer : public StreamerBase
{
  public:
    ...
    SerialStreamer(Option &option) : option_(option)
    {
...
class FileStreamer : public StreamerBase
{
  public:
    ...
    FileStreamer(Option &option) : option_(option)
    {
...
class TcpServerStreamer : public StreamerBase
{
  public:
    ...
    TcpServerStreamer(Option &option) : option_(option)
    {
...
class TcpClientStreamer : public StreamerBase
{
  public:
    ...
    TcpClientStreamer(Option &option) : option_(option)
    {
...
class NtripServerStreamer : public StreamerBase
{
  public:
    ...
    NtripServerStreamer(Option &option) : option_(option)
    {
...
class NtripClientStreamer : public StreamerBase
{
  public:
    ...
    NtripClientStreamer(Option &option) : option_(option)
    {
...
class V4l2Streamer : public StreamerBase
{
  public:
    ...
    V4l2Streamer(Option &option) : option_(option)
    {
