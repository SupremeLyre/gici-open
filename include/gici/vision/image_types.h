...
struct ExtrinsicsEstimationParameters
{
    ...
    ExtrinsicsEstimationParameters()
        : sigma_absolute_translation(0.0), sigma_absolute_orientation(0.0), sigma_c_relative_translation(0.0),
     ...
     */
    ExtrinsicsEstimationParameters(double sigma_absolute_translation, double sigma_absolute_orientation,
...
typedef std::vector<ExtrinsicsEstimationParameters, Eigen::aligned_allocator<ExtrinsicsEstimationParameters>>
