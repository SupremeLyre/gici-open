...
DgnssEstimator::DgnssEstimator(const DgnssEstimatorOptions &options, const GnssEstimatorBaseOptions &gnss_base_options,
                               const EstimatorBaseOptions &base_options)
    : dgnss_options_(options), GnssEstimatorBase(gnss_base_options, base_options), EstimatorBase(base_options)
{
...
bool DgnssEstimator::addGnssMeasurementAndState(const GnssMeasurement &measurement_rov,
                                                const GnssMeasurement &measurement_ref)
{
    ...
    GnssMeasurementDDIndexPairs index_pairs =
    ...
    addDdPseudorangeResidualBlocks(curGnssRov(), curGnssRef(), index_pairs, curState(), num_valid_satellite);
