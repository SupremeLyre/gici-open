...
template <int... Ns>
PseudorangeErrorSD<Ns...>::PseudorangeErrorSD(const GnssMeasurement &measurement_rov,
...
// Set the information.
template <int... Ns> void PseudorangeErrorSD<Ns...>::setInformation(const GnssErrorParameter &error_parameter)
{
    // compute variance
    ...
    covariance_ = covariance_t((square(factor(0)) + square(factor(1) / sin(elevation_rov))) * ratio * 2.0);
...
template <int... Ns>
bool PseudorangeErrorSD<Ns...>::Evaluate(double const *const *parameters, double *residuals, double **jacobians) const
{
...
template <int... Ns>
bool PseudorangeErrorSD<Ns...>::EvaluateWithMinimalJacobians(double const *const *parameters, double *residuals,
                                                             double **jacobians, double **jacobians_minimal) const
{
    ...
    double dpseudorange_estimate = rho_rov - rho_ref + dclock + dtroposphere_delay + dionosphere_delay;
