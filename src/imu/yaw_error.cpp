...
YawError::YawError(const double measurement, const double information)
{
...
bool YawError::Evaluate(double const *const *parameters, double *residuals, double **jacobians) const
{
...
bool YawError::EvaluateWithMinimalJacobians(double const *const *parameters, double *residuals, double **jacobians,
